...
int8_t o4fm_core_header(o4fm_core_header_t *header, char** p_output)
{
  ...
  *p_output = (char*)malloc(32);
  ...
  output[5] = header->mode;
  output[6] = header->flags;
  output[7] = header->fec_mode;
  output[8] = header->sender_id;
  output[9] = header->receiver_id;
